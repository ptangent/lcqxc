...
<div class="bs-component">
    <div class="alert alert-dismissible alert-success">
        ...
        <strong class="mobile_font_nor">乐诚钣金喷漆修复- 2014年虎门大道某特大事故</strong><a href="#" class="alert-link">车辆经维修后顺利回复良好车况</a>.
    </div>

    <div class="panel panel-danger">
        <div class="panel-heading">
            <h3 class="panel-title">修复前</h3>
        </div>
        <div class="panel-body">
            <img src="<?php echo base_url("ui_ref/images/appearance/before0.jpg"); ?>" class="img-responsive">
            <img src="<?php echo base_url("ui_ref/images/appearance/before1.jpg"); ?>" class="img-responsive">
            <img src="<?php echo base_url("ui_ref/images/appearance/before2.jpg"); ?>" class="img-responsive">
            <img src="<?php echo base_url("ui_ref/images/appearance/before3.jpg"); ?>" class="img-responsive">

        </div>
    </div>
    <div class="panel panel-info">
        <div class="panel-heading">
            <h3 class="panel-title">修复中</h3>
        </div>
        <div class="panel-body">
            <img src="<?php echo base_url("ui_ref/images/appearance/process1.jpg"); ?>" class="img-responsive">
        </div>
    </div>
    <div class="panel panel-success">
        ...
        <div class="panel-body">
            <img src="<?php echo base_url("ui_ref/images/appearance/after.jpg"); ?>" class="img-responsive">
        </div>
    </div>
